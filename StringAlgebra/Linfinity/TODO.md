...
6. `Coderivations.lean`: medium-high risk. Core interfaces are further hardened with explicit map/component consistency, unary-output shape constraints for components/brackets, and synchronized vanishing formulations; constructive co-Leibniz/component derivation remains pending.
