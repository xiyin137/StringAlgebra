...
5. Recent hardening completed:
   ...
   - `MaurerCartan.lean`: strengthened `MCTheory` with MC-preservation under gauge action (`gaugeAction_preserves_curvature_zero`), added theorem-level bridge (`gaugeAction_preservesMC`), and added canonical gauge action on MC elements (`MCElement.gaugeAct`).
