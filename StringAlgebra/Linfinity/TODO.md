...
5. Recent hardening completed:
   ...
   - `Formality.lean`: aligned theorem naming/documentation with witness-level semantics (`hkr_chain_equation`, `canonicalCommutator_firstOrder`, `poissonSigmaModel_witness`) and removed compatibility alias wrappers for historical names.
