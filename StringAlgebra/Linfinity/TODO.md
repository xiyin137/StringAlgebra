...
5. Recent hardening completed:
   ...
   - `MaurerCartan.lean`: aligned gauge/twisting/tangent-obstruction documentation and theorem naming with witness-level semantics (`twisted_diff_sq_zero_witness`) and removed historical compatibility-alias wrappers.
